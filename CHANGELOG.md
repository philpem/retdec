...
* Enhancement: Upgrade YARA to newer version 3.7.1 ([#218](https://github.com/avast-tl/retdec/issues/218)).
...
* Fix: Fixed segmentation fault in `retdec-fileinfo` caused by old YARA version ([#215](https://github.com/avast-tl/retdec/issues/215)).
